...
export class ConversorService {
  ...
  //eba7130a5b2d720ce43eb5fcddd47cc3
  ...
  /**
   * Retorna a cotação da moeda de destino dado uma response.
   * 
   * @param conversaoResponse ConversaoResponse.
   * @param conversao Conversao
   * @returns number
   */
  cotacaoMoedaDeDestino(conversaoResponse: ConversaoResponse,
  ...
  /**
   * Retorna a cotação da moeda de origem dado uma response.
   * 
   * @param conversaoResponse ConversaoResponse
   * @param conversao Conversao
   * @returns string
   */
  cotacaoMoedaDeOrigem(conversaoResponse: ConversaoResponse,
